...
Be sure to set the Platform as Java and choose to **Upload your code**.  Browse to the jar in your target folder choose it to upload. Then click the **Upload** button at the bottom. **NOTE** Do not go on though till you read the rest of this paragraph!  You need to make sure you Configure more options before continuing.  See the Screenshot below.
